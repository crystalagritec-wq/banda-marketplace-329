...
export default function ProfileScreen() {
  ...
  return (
    <View style={styles.container} testID="profile-screen">
      <ScrollView contentContainerStyle={styles.scroll} testID="profile-scroll" showsVerticalScrollIndicator={false}>
...
const styles = StyleSheet.create({
  ...
  name: { color: '#111827', fontSize: 22, fontWeight: '700' as const },
  ...
  ribbonText: { fontSize: 12, color: '#065F46', fontWeight: '600' as const },
  ...
  statValue: { fontSize: 18, fontWeight: '700' as const, color: '#111827', marginBottom: 2 },
  ...
  seeAllText: { color: '#2D5016', fontWeight: '600' as const, fontSize: 12 },
  ...
  actionTitle: { fontSize: 14, fontWeight: '700' as const, color: '#111827' },
