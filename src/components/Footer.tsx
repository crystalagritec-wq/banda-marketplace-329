        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Banda Marketplace</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Your trusted online marketplace for quality products from local and international sellers. 
              Discover amazing deals and connect with sellers in your community.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Banda Marketplace. All rights reserved.
            </p>
